...
public class FindPublicationYearCommandTest {
    FindPublicationYearCommand command;
    Book book1;
    Book book2;
    Book book3;
    Book book4;
    ...
    @BeforeTest
    public void setUp() {
        command = new FindPublicationYearCommand();
    ...
    public void executeExceptionTest() throws CommandException {
        Map<String, String> parameters = Map.of("year", "1478");
